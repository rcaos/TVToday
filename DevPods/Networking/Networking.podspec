...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jeans Ruiz/Networking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jeans Ruiz' => 'jeansruiz.c@gmail.com' }
  s.source           = { :git => 'https://github.com/Jeans Ruiz/Networking.git', :tag => s.version.to_s }
  ...
  s.resource = 'Networking/Module/**/*.{xcassets,json,storyboard,xib,xcdatamodeld}'
